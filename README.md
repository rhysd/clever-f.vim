...
clever-f can search multibyte Japanese character with `f`, 'F', 't' and 'T' key mappings. Migemo is **NOT** required because clever-f includes regex patterns generated by migemo.
